...
#ifndef EXPNB_NORTH_INTF_H
#define EXPNB_NORTH_INTF_H
...
* Buffers information
*/
extern int expnb_buf_count;   /**< number of buffer allocated for read/write on north interface */
extern int expnb_buf_sz;      /**<read:write buffer size on north interface */

extern void *expnb_receive_buffer_pool_p ;  /**< reference of the read/write buffer pool */
extern void *expnb_xmit_buffer_pool_p ;  /**< reference of the read/write buffer pool */

#define EXPNB_BUF_RECV_CNT 8
#define EXPNB_BUF_RECV_SZ  (1024*32) 
