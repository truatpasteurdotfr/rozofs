...
static void on_start(uint16_t port_io) {
    ...
    */
    ...
    if ((storaged_svc = storaged_create_rpc_service(port_io, storaged_hostname)) == NULL) {
    ...
    if ((storaged_profile_svc = storaged_create_rpc_service(port_io + 1000,storaged_hostname)) == NULL) {
