...
*/
void * storage_north_RcvAllocBufCallBack(void *userRef,uint32_t socket_context_ref,uint32_t len)
{
  /*
...
*/
uint32_t storage_north_userRcvReadyCallBack(void * socket_ctx_p,int socketId)
{
...
* test function that is called upon a failure on sending
 ...
 @retval none
*/
void  storage_north_userDiscCallBack(void *userRef,uint32_t socket_context_ref,void *bufRef,int err_no)
{
 ...
 af_unix_socket_conf_t  af_inet_rozofs_north_conf =
{
  ...
  storage_north_RcvAllocBufCallBack,  //    userRcvAllocBufCallBack; /* user callback for buffer allocation */
  storage_req_rcv_cbk,           //    userRcvCallBack;   /* callback provided by the connection owner block */
  storage_north_userDiscCallBack,   //    userDiscCallBack; /* callBack for TCP disconnection detection         */
  ...
  storage_north_userRcvReadyCallBack,  //    userRcvReadyCallBack; /* NULL for default callback                     */
